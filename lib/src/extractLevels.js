...
/**
 * Get filename for input argument
 * @param {string} getUsageError - error generated if user does not define argument correctly
 * @return {string} filename from command line.
 * */
export function getArgInputFilename(getUsageError) {
