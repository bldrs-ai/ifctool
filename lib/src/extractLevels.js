...
async function extractLevels() {
  ...
  const ifcFilename = getIFCFileName()
...
function getIFCFileName() {
  ...
  console.warn('Problem is here', ifcFilename)
  return ifcFilename
}
...
export async function extractRELID(ifcFilename) {
  ...
  console.warn('Test01: '+ifcFilename)
 ...
 * @param {string} ifcFilename extracted ifc filename
 */
function createManipulateNewIFC(relatedElemGrouped, ifcFilename) {
