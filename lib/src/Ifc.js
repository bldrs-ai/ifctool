...
export async function derefNew(ref, webIfc = null, indent = '') {
  ...
  if (Array.isArray(ref)) {
    ...
    if (isTypeValue(ref)) {
      ...
      switch (ref.type) {
        case STRING: return decodeIFCString(ref.value) // typically strings.
        case LABEL: return ref.value
        case ENUM: return ref.value // values are typically in CAPS
        case REAL: return ref.value // typically measures of space, time or angle.
        case REF: {
